...
func MapLogRecordToSplunkEvent(res pcommon.Resource, lr plog.LogRecord) *Event {
	body := lr.Body().AsRaw()
	if body == nil || body == "" {
	...
	severityTextKey := DefaultSeverityTextLabel
	severityNumberKey := DefaultSeverityNumberLabel
